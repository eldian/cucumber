...
/**
 * Created by eldiandervishi on 6/9/17.
 */
public class BasePage {
	...
	public void selectFromAutoCompleteByText(By locator, String string) throws StaleElementReferenceException, NoSuchElementException{
		try {
	...
	public void selectDropDown(By locator, int index) throws StaleElementReferenceException, NoSuchElementException {
		try {
