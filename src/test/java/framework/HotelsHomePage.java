...
/**
 * Created by eldiandervishi on 3/14/18.
 */
public class HotelsHomePage extends BasePage {
    ...
    private By clickOnCheckIn = By.cssSelector("#qf-0q-localised-check-in");
    private By clickOnCheckOut = By.cssSelector("#qf-0q-localised-check-out");
